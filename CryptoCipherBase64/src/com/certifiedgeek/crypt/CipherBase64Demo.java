package com.certifiedgeek.crypt;
...
public class CipherBase64Demo {
    ...
    public CipherBase64Demo() throws UnsupportedEncodingException, NoSuchPaddingException, NoSuchAlgorithmException {
	...
	public static void main(String[] args) {
		...
		try {
			CipherBase64Demo c = new CipherBase64Demo();
			//Enter password
			String encrypted = c.encrypt("Password1");
